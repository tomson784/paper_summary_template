...
articles_dir = "./resources_dir/"
articles_meta = "./resources_meta/"
...
def home_cate():
    articles_paths = glob.glob(articles_meta + "/*.md")
...
@app.route('/classification/<category>/<article>.html')
def show_article_meta(category, article):
    path = articles_meta + "/" + article + ".md"
    html_, meta = markdown2html(path)
    print(meta)
